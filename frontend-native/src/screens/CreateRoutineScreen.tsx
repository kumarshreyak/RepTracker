...
interface CreateRoutineScreenProps {
  user: User;
  onNavigateBack: () => void;
  onNavigateToExerciseSearch: () => void;
}

export const CreateRoutineScreen: React.FC<CreateRoutineScreenProps> = ({ 
  user, 
  onNavigateBack, 
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <Button variant="text" size="default" onPress={onNavigateBack}>
            ← Back to Home
          </Button>
        ...
        <View style={styles.card}>
          <View style={styles.exercisesHeader}>
            ...
            <View style={styles.exercisesActions}>
              ...
              <Button variant="primary" size="default" onPress={onNavigateToExerciseSearch}>
                Add Exercise
              </Button>
            </View>
          </View>
